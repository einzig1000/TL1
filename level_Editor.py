...
class MYADDON_OT_export_scene(bpy.types.Operator, bpy_extras.io_utils.ExportHelper):
    ...
    def parse_scene_recursive(self, file, object, level):
        ...
        if "collider" in object:
            file.write(indent + "C %s" % object["collider"] + "\n")
            file.write(indent + "CC %f %f %f\n" % 
                       (object["collider_center"][0], 
                        object["collider_center"][1], 
                        object["collider_center"][2]))
            file.write(indent + "CS %f %f %f\n" % 
...
class OBJECT_PT_collider(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if "collider" in context.object:
            ...
            self.layout.operator("myaddon.myaddon_ot_add_collider", text="Add Collider", icon="MESH_CUBE")
